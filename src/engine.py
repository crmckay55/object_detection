...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        new_rate = config.LEARNING_RATE_START * math.pow(config.LEARNING_RATE_DECAY, epoch)
        for g in optimizer.param_groups:
            g['lr'] = new_rate

        # TODO: here is where the scheduler.step() would go
        print('Learning Rate at epoch ' + str(epoch) + ': ' + str(new_rate))
